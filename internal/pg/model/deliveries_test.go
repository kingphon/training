...
func testDeliveryToManyOrders(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = a.L.LoadOrders(ctx, tx, false, (*[]*Delivery)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testDeliveryToManyAddOpOrders(t *testing.T) {
	var err error
...
func testDeliveryToOneLocationUsingLocation(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	seed := randomize.NewSeed()
	if err := randomize.Struct(seed, &local, deliveryDBTypes, false, deliveryColumnsWithDefault...); err != nil {
		t.Errorf("Unable to randomize Delivery struct: %s", err)
	}
	...
	if err = local.L.LoadLocation(ctx, tx, false, (*[]*Delivery)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testDeliveryToOneUserUsingUser(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
...
func testDeliveryToOneWarehouseUsingWarehouse(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := DeliverySlice{&local}
	if err = local.L.LoadWarehouse(ctx, tx, false, (*[]*Delivery)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testDeliveryToOneSetOpLocationUsingLocation(t *testing.T) {
	var err error
...
func testDeliveryToOneSetOpUserUsingUser(t *testing.T) {
	var err error
...
func testDeliveryToOneSetOpWarehouseUsingWarehouse(t *testing.T) {
	var err error
...
var (
	deliveryDBTypes = map[string]string{`ID`: `text`, `Code`: `text`, `Title`: `text`, `ShipFee`: `numeric`, `Status`: `text`, `UserID`: `text`, `EstimateDate`: `timestamp with time zone`, `UserInfo`: `jsonb`, `WarehouseID`: `text`, `WarehouseInfo`: `jsonb`, `LocationID`: `text`, `LocationInfo`: `jsonb`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`}
	_               = bytes.MinRead
)
