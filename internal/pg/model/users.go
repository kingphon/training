...
var UserWhere = struct {
	...
	ID:        whereHelpernull_String{field: "\"users\".\"_id\""},
...
type userR struct {
	...
	UserBankCards UserBankCardSlice `boil:"UserBankCards" json:"UserBankCards" toml:"UserBankCards" yaml:"UserBankCards"`
...
func (r *userR) GetDeliveries() DeliverySlice {
	if r == nil {
		return nil
	}
	return r.Deliveries
...
func (r *userR) GetLocations() LocationSlice {
	if r == nil {
		return nil
	}
	return r.Locations
...
func (r *userR) GetShops() ShopSlice {
	if r == nil {
		return nil
	}
	return r.Shops
...
func (r *userR) GetUserBankCards() UserBankCardSlice {
	if r == nil {
		return nil
	}
	return r.UserBankCards
}

func (r *userR) GetWarehouses() WarehouseSlice {
	if r == nil {
		return nil
	}
	return r.Warehouses
...
var (
	userAllColumns            = []string{"_id", "name", "status", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"_id", "name", "status", "created_at", "updated_at"}
	userColumnsWithDefault    = []string{}
	userPrimaryKeyColumns     = []string{"_id"}
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "modelpg: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "modelpg: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "modelpg: failed to check if users exists")
	}
...
func (o *User) Deliveries(mods ...qm.QueryMod) deliveryQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (o *User) Shops(mods ...qm.QueryMod) shopQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"shops\".\"user_id\"=?", o.ID),
	)

	return Shops(queryMods...)
}

// UserBankCards retrieves all the user_bank_card's UserBankCards with an executor.
func (o *User) UserBankCards(mods ...qm.QueryMod) userBankCardQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_bank_cards\".\"user_id\"=?", o.ID),
	)

	return UserBankCards(queryMods...)
}

// Warehouses retrieves all the warehouse's Warehouses with an executor.
func (o *User) Warehouses(mods ...qm.QueryMod) warehouseQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"warehouses\".\"user_id\"=?", o.ID),
	)
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadDeliveries(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (userL) LoadLocations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`locations`),
		qm.WhereIn(`locations.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadPayments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`payments`),
		qm.WhereIn(`payments.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadShops(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`shops`),
		qm.WhereIn(`shops.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// LoadUserBankCards allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserBankCards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_bank_cards`),
		qm.WhereIn(`user_bank_cards.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	results, err := query.QueryContext(ctx, e)
	if err != nil {
		return errors.Wrap(err, "failed to eager load user_bank_cards")
	}

	var resultSlice []*UserBankCard
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice user_bank_cards")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on user_bank_cards")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for user_bank_cards")
	}
	...
	if singular {
		object.R.UserBankCards = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
				foreign.R = &userBankCardR{}
			}
			foreign.R.User = object
		}
		return nil
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.UserID) {
				local.R.UserBankCards = append(local.R.UserBankCards, foreign)
				if foreign.R == nil {
					foreign.R = &userBankCardR{}
				}
				foreign.R.User = local
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadWarehouses(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`warehouses`),
		qm.WhereIn(`warehouses.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddDeliveries(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Delivery) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// Sets related.R.User appropriately.
func (o *User) AddShops(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Shop) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
// AddUserBankCards adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UserBankCards.
// Sets related.R.User appropriately.
func (o *User) AddUserBankCards(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserBankCard) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
	...
	if o.R == nil {
		o.R = &userR{
			UserBankCards: related,
		}
	} else {
		o.R.UserBankCards = append(o.R.UserBankCards, related...)
	}
...
// Sets related.R.User appropriately.
func (o *User) AddWarehouses(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Warehouse) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UserID, o.ID)
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD null.String, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"_id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "modelpg: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("modelpg: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "modelpg: unable to insert into users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("modelpg: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("modelpg: no users provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("modelpg: unable to upsert users, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(userPrimaryKeyColumns) == 0 {
				return errors.New("modelpg: unable to upsert users, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "modelpg: unable to upsert users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("modelpg: no User provided for delete")
	}
	...
	sql := "DELETE FROM \"users\" WHERE \"_id\"=$1"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("modelpg: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "modelpg: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "modelpg: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD null.String) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"_id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "modelpg: unable to check if users exists")
	}
